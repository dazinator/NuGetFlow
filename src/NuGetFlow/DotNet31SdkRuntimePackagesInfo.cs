...
public class DotNet31SdkRuntimePackagesInfo : IRuntimePackagesInfo
{
    /// <summary>
    ...
    public virtual bool IsPackageProvidedByRuntime(string packageId) => _providedPackages.Contains(packageId);
